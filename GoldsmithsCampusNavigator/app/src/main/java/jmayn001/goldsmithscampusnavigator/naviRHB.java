...
public class naviRHB {
	...
	public void extractInfo() {
		RHB_F1_E = new Extractor("jmayn001/goldsmithscampusnavigator/RHB_Layout_F1.txt");
		RHB_F2_E = new Extractor("jmayn001/goldsmithscampusnavigator/RHB_Layout_F2.txt");
		RHB_F3_E = new Extractor("jmayn001/goldsmithscampusnavigator/RHB_Layout_F3.txt");
		RHB_F1_E.printFile();
		RHB_F2_E.printFile();
		RHB_F3_E.printFile();
	}
	...
	private void makeGraph() {
		try {
			RHB_F1 = new graphMaker("jmayn001/goldsmithscampusnavigator/RHB_Layout_F1_info.txt", "F1_");
			RHB_F2 = new graphMaker("jmayn001/goldsmithscampusnavigator/RHB_Layout_F2_info.txt", "F2_");
			RHB_F3 = new graphMaker("jmayn001/goldsmithscampusnavigator/RHB_Layout_F3_info.txt", "F3_");
		} catch (IOException e) {
	...
	private String linkFloors(LinkedList<String> path) {
		...
		destination[1] = '1';
		if(Pathfinder.liftMode) return new String(destination);
		destination[4] = 'U';
