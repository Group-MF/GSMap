...
public class Searcher {
	...
	public Searcher() throws IOException{
		rtv_f1 = createRTV("jmayn001/goldsmithscampusnavigator/RHB_F1_RTN.txt", rtv_f1);
		rtv_f2 = createRTV("jmayn001/goldsmithscampusnavigator/RHB_F2_RTN.txt", rtv_f2);
		rtv_f3 = createRTV("jmayn001/goldsmithscampusnavigator/RHB_F3_RTN.txt", rtv_f3);
	}
